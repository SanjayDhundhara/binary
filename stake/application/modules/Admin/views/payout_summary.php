                    ...
                    <tbody>
                        ...
                        foreach ($records as $key => $record) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $record['incomes']['dividend_share']; ?></td>
                                <td><?php echo $record['incomes']['booster_income']; ?></td>
                                <td><?php echo $record['incomes']['level_income']; ?></td>
                                <td><?php echo $record['incomes']['direct_sponsor_leadership']; ?></td>
                                <td><?php echo $record['incomes']['bonanza_rewards']; ?></td>
