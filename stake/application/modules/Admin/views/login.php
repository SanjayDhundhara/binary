...
<html dir="ltr" lang="en">
    ...
    <body>
        ...
        <style>
        body{
          background:url(https://www.bigdataforhumans.com/media/1164/gdpr_success-1.jpeg); background-size:cover; padding:40px 0px
        }
        p {
    margin: 0 0 10px;
    color: #fff;
                                    ...
                                    <div id="CPH1_Up1">
                                        <div id="CPH1_updProgress" style="display:block;">
                                            <div class="ProgressBg" style="background: #000;">
                                                <center>
                                                    <img alt="progress" src="<?php echo base_url(logo); ?>" width="200px" />
                                                </center>
                                            </div>
                                        </div>
                                        <div class="log-box">
                                            <span class="text-center text-danger"><?php echo $message; ?></span>
                                            <?php echo form_open(base_url('Admin/Management/login'), array('id' => 'loginForm')); ?>
                                            <form id="login-form" action="" method="post"  style="display:block">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="irs-donation-col">
                                                        <button class="btn btn-success pull-right" type="submit">Login Now</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
