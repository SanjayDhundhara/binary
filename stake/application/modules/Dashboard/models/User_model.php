...
//        echo $this->db->last_query();
    ...
    public function calculateTeam($user_id,$status){
        ...
        $this->db->where(array('tbl_sponser_count.user_id' => $user_id ,'tbl_users.paid_status' => $status,'tbl_sponser_count.level <=' => 12));
        $query = $this->db->get();
        $res = $query->row_array();
        return $res;
    }
