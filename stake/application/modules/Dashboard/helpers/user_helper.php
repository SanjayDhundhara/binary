...
if (!function_exists('userMail')) {
    function userMail($email,$subject,$message){
        $curl = curl_init();

        curl_setopt_array($curl, array(
          CURLOPT_URL => 'http://64.227.105.87:8000/zoho_send_email',
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => '',
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
          ...
          CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
          CURLOPT_CUSTOMREQUEST => 'POST',
          CURLOPT_POSTFIELDS => 'email='.$email.'&subject='.$subject.'&html=<div style=\' background: #000000;
    margin: auto;
    max-width: 400px;
    padding: 20px;
    border: 4px #4ce7ff solid;
    margin: 10px auto;\'><center><img style=\'max-width:200px;margin: 0;border-radius: 10px;\' src=\'https://login.zaaracoin.io/uploads/logo.png\' alt=\'logo\'><br><h3 style=\'color:#fff;\'>'.$message.'</h3><div style=\'font-size:20px;font-weight: bold; color:#ffea81; margin-top:20px\'><a href=\'https://kissan.io/refferal/Dashboard/User/MainLogin\' style=\'background-color:#17b824; color:#fff;width: 100%; font-weight:normal; border-radius: 4px;  display: block;\'>Click here to login</a></div></center></div>',
          CURLOPT_HTTPHEADER => array(
