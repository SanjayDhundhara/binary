                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($users as $key => $user) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo !empty($stake)?'MPY ':'$ '; echo $user['teamBusiness']; ?></td>
                                                            <?php if(!empty($stake)):?>
                                                                <td><?php echo '$ '; echo $user['teamBusiness2']; ?></td>
                                                                <td><?php echo '<a style="background:orange;color:white; font-weight:bold;padding:10px 15px" href="'.base_url('Dashboard/Network/stakeLevelDetails/'.$user['level']).'">View</a>'; ?></td>
                                                            <?php else:?>
                                                                <td><?php echo '<a style="background:orange;color:white; font-weight:bold;padding:10px 15px" href="'.base_url('Dashboard/Network/levelDetails/'.$user['level']).'">View</a>'; ?></td>
                                                            <?php endif;?>
