                ...
                <table class="table table-bordered table-striped dataTable" id="">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo $user['downline_id']; ?></td>
                                <td><?php echo $user['userinfo']['name']; ?></td>
                                <td><?php echo $user['userinfo']['sponser_id']; ?></td>
                                <?php if(!empty($stake)):?>
                                    <td><?php echo 'MPY '.$user['business']['business']; ?></td>
                                    <td><?php echo '$ '.$user['business']['investment2']; ?></td>
                                <?php else:?>
                                    <td><?php echo '$ '.$user['business']['business']; ?></td>
                                <?php endif;?>
