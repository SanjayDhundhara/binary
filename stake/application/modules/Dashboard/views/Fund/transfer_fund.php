...
<div class="container-fluid pt-5 content-wrapper">
<section class="">
    <!-- BEGIN breadcrumb -->
    ...
    <div class="content">
      <div class="head-top">
        <h4 class="page-header text-dark">P2P Wallet ($<?php echo $wallet_amount['wallet_amount']?>) </h4>
      </div>
