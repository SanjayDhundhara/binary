...
<div class="card">
    <div class="card-body">
        ...
        <?php
            ...
            //     echo 'Please activate your account to see downline';
            // }else{
        ?>
        <div class="row">
            <!-- BEGIN col-3 -->
            <div class="col-lg-12">
                <div class="search-bar bg-white" style="padding: 20px;">
                    <form action="<?php echo base_url('Dashboard/User/GenelogyTree/');?>" id="srchform" method="GET">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                ?>
                                <a class="btn btn-success" style="" href="<?php echo base_url('Dashboard/User/GenelogyTree/'.$this->session->userdata['user_id']);?>"><i class="icon-home"></i>  Go to My view</a>
                            </div>
                        </div>
                    </form>
                </div>
                                                    ...
                                                    <tr id="p0">
                                                        ...
                                                        <td colspan="2" align="center">
                                                            <a href="#" class="has-tooltip">
                                                                <img src="<?php echo tree_img($level1->package_amount,0); ?>" alt="<?php echo $level1->name;?>" border="0" width="60">
                                                                <span class="on-hover">
                                                                    Username : <?php echo $level1->user_id;?> <br>
                                                                    Sponsor ID : <?php echo $level1->sponser_id;?> <br>

                                                                    Package : <?php echo $level1->package_amount;?>  <br>
                                                                    Left team : <?php echo $level1->left_count;?> | Right team : <?php echo $level1->right_count;?> <br>
                                                                    <?php echo $level1->right_count;?> <br>
                                                                    Left Green Team : <?php echo downlineTeam($level1->user_id,1,'L');?> | Right Green Team : <?php echo downlineTeam($level1->user_id,1,'R');?><br>
                                                                    
                                                                    Left Business : <?php echo $level1->leftPower;?> | Right Business : <?php echo $level1->rightPower;?> <br>
                                                                </span>
                                                            </a>
                                                            <br>
                                                    ...
                                                    <tr>
                                                        <td colspan="4" align="center">
                                                            <table width="50%" border="0" align="center" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td align="center"><img src="<?php echo base_url('SiteAssets/treeimage');?>/arrow.jpg" width="100%"></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </td>
                                                                    ...
                                                                    <tr valign="top">
                                                                        ...
                                                                        if(!empty($level2[1]->user_id)){
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level2[1]->user_id).'" class="has-tooltip">
                                                                                    <img src="'.tree_img($level2[1]->package_amount,0).'" alt="'. $level2[1]->name.'" border="0" width="60">
                                                                                    <span class="on-hover">
                                                                                        Username : '. $level2[1]->name.' <br>
                                                                                        Sponser ID : '. $level2[1]->sponser_id.' <br>

                                                                                        Package : '.$level2[1]->package_amount.'  <br>
                                                                                        Left team : '.$level2[1]->left_count.' | Right team : '.$level2[1]->right_count.' <br>
                                                                                        Left Green Team : '.downlineTeam($level2[1]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level2[1]->user_id,1,'R').'<br>
                                                                                       
                                                                                        Left Business : '.$level2[1]->leftPower.' | Right Business : '.$level2[1]->rightPower.' <br>
                                                                                    </span>
                                                                                </a>
                                                                                <br>
                                                                        ...
                                                                        if(!empty($level2[2]->user_id)){
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level2[2]->user_id).'" class="has-tooltip">
                                                                                    <img src="'.tree_img($level2[2]->package_amount,0).'" alt="'. $level2[2]->name.'" border="0" width="60">
                                                                                    <span class="on-hover">
                                                                                        Username : '. $level2[2]->name.' <br>
                                                                                        Sponser ID : '. $level2[2]->sponser_id.' <br>

                                                                                        Package : '.$level2[2]->package_amount.'  <br>
                                                                                        Left team : '.$level2[2]->left_count.' | Right team : '.$level2[2]->right_count.' <br>
                                                                                         Left Green Team : '.downlineTeam($level2[2]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level2[2]->user_id,1,'R').'<br>
                                                                                       
                                                                                        Left Business : '.$level2[2]->leftPower.' | Right Business : '.$level2[2]->rightPower.' <br>
                                                                                    </span>
                                                                                </a>
                                                                                <br>
                                                                        ...
                                                                        <td width="50%" height="28" align="center">
                                                                            <table width="50%" border="0" align="center"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td valign="top">
                                                                                            <img src="<?php echo base_url('SiteAssets/treeimage');?>/arrow1.jpg" width="100%">
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                    ...
                                                                    <tr align="center">
                                                                        ...
                                                                        if(!empty($level3[1]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[1]->user_id).'" class="has-tooltip">
                                                                                    <img src="'.tree_img($level3[1]->package_amount,0).'" alt="'. $level3[1]->name.'" border="0" width="60">
                                                                                    <span class="on-hover">
                                                                                        Username : '. $level3[1]->name.' <br>
                                                                                        Sponser ID : '. $level3[1]->sponser_id.' <br>

                                                                                        Package : '.$level3[1]->package_amount.'  <br>
                                                                                        Left team : '.$level3[1]->left_count.' | Right team : '.$level3[1]->right_count.' <br>
                                                                                         Left Green Team : '.downlineTeam($level3[1]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level3[1]->user_id,1,'R').'<br>
                                                                                       
                                                                                        Left Business : '.$level3[1]->leftPower.' | Right Business : '.$level3[1]->rightPower.' <br>
                                                                                    </span>
                                                                                    </a>
                                                                                    <br>
                                                                        ...
                                                                        if(!empty($level3[2]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[2]->user_id).'" class="has-tooltip">
                                                                                        <img src="'.tree_img($level3[2]->package_amount,0).'" alt="'.$level3[2]->name.'" border="0" width="60">
                                                                                        <span class="on-hover">
                                                                                            Username : '. $level3[2]->name.' <br>
                                                                                            Sponser ID : '. $level3[2]->sponser_id.' <br>

                                                                                            Package : '.$level3[2]->package_amount.'  <br>
                                                                                            Left team : '.$level3[2]->left_count.' | Right team : '.$level3[2]->right_count.' <br>
                                                                                             Left Green Team : '.downlineTeam($level3[2]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level3[2]->user_id,1,'R').'<br>
                                                                                            
                                                                                            Left Business : '.$level3[2]->leftPower.' | Right Business : '.$level3[2]->rightPower.' <br>
                                                                                        </span>
                                                                                    </a>
                                                                                    <br>
                                                                        ...
                                                                        if(!empty($level3[3]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[3]->user_id).'" class="has-tooltip">
                                                                                        <img src="'.tree_img($level3[3]->package_amount,0).'" alt="'.$level3[3]->name.'" border="0" width="60">
                                                                                        <span class="on-hover">
                                                                                            Username : '. $level3[3]->name.' <br>
                                                                                            Sponsor ID : '. $level3[3]->sponser_id.' <br>

                                                                                            Package : '.$level3[3]->package_amount.' <br>
                                                                                            Left team : '.$level3[3]->left_count.' | Right team : '.$level3[3]->right_count.' <br>
                                                                                            Left Green Team : '.downlineTeam($level3[3]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level3[3]->user_id,1,'R').'<br>
                                                                                            
                                                                                            Left Business : '.$level3[3]->leftPower.' | Right Business : '.$level3[3]->rightPower.' <br>
                                                                                        </span>
                                                                                    </a>
                                                                                    <br>
                                                                        ...
                                                                        if(!empty($level3[4]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[4]->user_id).'" class="has-tooltip">
                                                                                        <img src="'.tree_img($level3[4]->package_amount,0).'" alt="'.$level3[4]->name.'" border="0" width="60">
                                                                                        <span class="on-hover">
                                                                                            Username : '. $level3[4]->name.' <br>
                                                                                            Sponsor ID : '. $level3[4]->sponser_id.' <br>

                                                                                            Package : '.$level3[4]->package_amount.' <br>
                                                                                            Left team : '.$level3[4]->left_count.' | Right team : '.$level3[4]->right_count.' <br>
                                                                                            Left Green Team : '.downlineTeam($level3[4]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level3[4]->user_id,1,'R').'<br>
                                                                                           
                                                                                            Left Business : '.$level3[4]->leftPower.' | Right Business : '.$level3[4]->rightPower.' <br>
                                                                                        </span>
                                                                                    </a>
                                                                                    <br>
                                                                        ...
                                                                        <td width="25%" height="15%">
                                                                            <table width="50%" border="0" align="center"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td valign="top"><img
                                                                                                src="<?php echo base_url('SiteAssets/treeimage');?>/arrow2.jpg"
                                                                                                width="100%"></td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr align="center" valign="top">
                                                                                        ...
                                                                                        if(!empty($level4[1]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[1]->user_id).'" class="has-tooltip">
                                                                                                        <img src="'.tree_img($level4[1]->package_amount,0).'" alt="'.$level4[1]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                                            Username : '. $level4[1]->name.' <br>
                                                                                                            Sponsor ID : '. $level4[1]->sponser_id.' <br>

                                                                                                            Package : '.$level4[1]->package_amount.' <br>
                                                                                                            Left team : '.$level4[1]->left_count.' | Right team : '.$level4[1]->right_count.' <br>
                                                                                                             Left Green Team : '.downlineTeam($level4[1]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level4[1]->user_id,1,'R').'<br>
                                                                                                            
                                                                                                            Left Business : '.$level4[1]->leftPower.' | Right Business : '.$level4[1]->rightPower.' <br>
                                                                                                        </span>
                                                                                                    </a>
                                                                                                    <br>
                                                                                        ...
                                                                                        if(!empty($level4[2]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[2]->user_id).'" class="has-tooltip">
                                                                                                        <img src="'.tree_img($level4[2]->package_amount,0).'" alt="'.$level4[2]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                                            Username : '. $level4[2]->name.' <br>
                                                                                                            Sponsor ID : '. $level4[2]->sponser_id.' <br>

                                                                                                            Package : '.$level4[2]->package_amount.' <br>
                                                                                                            Left team : '.$level4[2]->left_count.' | Right team : '.$level4[2]->right_count.' <br>
                                                                                                             Left Green Team : '.downlineTeam($level4[2]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level4[2]->user_id,1,'R').'<br>
                                                                                                            
                                                                                                            Left Business : '.$level4[2]->leftPower.' | Right Business : '.$level4[2]->rightPower.' <br>
                                                                                                        </span>
                                                                                                    </a>
                                                                                                    <br>
                                                                                        ...
                                                                                        if(!empty($level4[3]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[3]->user_id).'" class="has-tooltip">
                                                                                                        <img src="'.tree_img($level4[3]->package_amount,0).'" alt="'.$level4[3]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                                            Username : '. $level4[3]->name.' <br>
                                                                                                            Sponsor ID : '. $level4[3]->sponser_id.' <br>

                                                                                                            Package : '.$level4[3]->package_amount.' <br>
                                                                                                            Left team : '.$level4[3]->left_count.' | Right team : '.$level4[3]->right_count.' <br>
                                                                                                             Left Green Team : '.downlineTeam($level4[3]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level4[3]->user_id,1,'R').'<br>
                                                                                                            
                                                                                                            Left Business : '.$level4[3]->leftPower.' | Right Business : '.$level4[3]->rightPower.' <br>
                                                                                                        </span>
                                                                                                    </a>
                                                                                                    <br>
                                                                                        ...
                                                                                        if(!empty($level4[4]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[4]->user_id).'" class="has-tooltip">
                                                                                                        <img src="'.tree_img($level4[4]->package_amount,0).'" alt="'.$level4[4]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                                            Username : '. $level4[4]->name.' <br>
                                                                                                            Sponsor ID : '. $level4[4]->sponser_id.' <br>


                                                                                                            Package : '.$level4[4]->package_amount.' <br>
                                                                                                            Left team : '.$level4[4]->left_count.' | Right team : '.$level4[4]->right_count.' <br>
                                                                                                             Left Green Team : '.downlineTeam($level4[4]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level4[4]->user_id,1,'R').'<br>
                                                                                                            
                                                                                                            Left Business : '.$level4[4]->leftPower.' | Right Business : '.$level4[4]->rightPower.' <br>
                                                                                                        </span>
                                                                                                    </a>
                                                                                                    <br>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr align="center" valign="top">
                                                                                        ...
                                                                                        if(!empty($level4[5]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[5]->user_id).'" class="has-tooltip">
                                                                                                        <img src="'.tree_img($level4[5]->package_amount,0).'" alt="'.$level4[5]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                                            Username : '. $level4[5]->name.' <br>
                                                                                                            Sponsor ID : '. $level4[5]->sponser_id.' <br>

                                                                                                            Package : '.$level4[5]->package_amount.' <br>
                                                                                                            Left team : '.$level4[5]->left_count.' | Right team : '.$level4[5]->right_count.' <br>
                                                                                                             Left Green Team : '.downlineTeam($level4[5]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level4[5]->user_id,1,'R').'<br>
                                                                                                           
                                                                                                            Left Business : '.$level4[5]->leftPower.' | Right Business : '.$level4[5]->rightPower.' <br>
                                                                                                        </span>
                                                                                                    </a>
                                                                                                    <br>
                                                                                        ...
                                                                                        if(!empty($level4[6]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[6]->user_id).'" class="has-tooltip">
                                                                                                        <img src="'.tree_img($level4[6]->package_amount,0).'" alt="'.$level4[6]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                                            Username : '. $level4[6]->name.' <br>
                                                                                                            Sponsor ID : '. $level4[6]->sponser_id.' <br>

                                                                                                            Package : '.$level4[6]->package_amount.' <br>
                                                                                                            Left team : '.$level4[6]->left_count.' | Right team : '.$level4[6]->right_count.' <br>
                                                                                                             Left Green Team : '.downlineTeam($level4[6]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level4[6]->user_id,1,'R').'<br>
                                                                                                            
                                                                                                            Left Business : '.$level4[6]->leftPower.' | Right Business : '.$level4[6]->rightPower.' <br>
                                                                                                        </span>
                                                                                                    </a>
                                                                                                    <br>
                                                                                        ...
                                                                                        if(!empty($level4[7]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[7]->user_id).'" class="has-tooltip">
                                                                                                        <img src="'.tree_img($level4[7]->package_amount,0).'" alt="'.$level4[7]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                                            Username : '. $level4[7]->name.' <br>
                                                                                                            Sponsor ID : '. $level4[7]->sponser_id.' <br>

                                                                                                            Package : '.$level4[7]->package_amount.' <br>
                                                                                                            Left team : '.$level4[7]->left_count.' | Right team : '.$level4[7]->right_count.' <br>
                                                                                                             Left Green Team : '.downlineTeam($level4[7]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level4[7]->user_id,1,'R').'<br>
                                                                                                            
                                                                                                            Left Business : '.$level4[7]->leftPower.' | Right Business : '.$level4[7]->rightPower.' <br>
                                                                                                        </span>
                                                                                                    </a>
                                                                                                    <br>
                                                                                        ...
                                                                                        if(!empty($level4[8]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[8]->user_id).'" class="has-tooltip">
                                                                                                        <img src="'.tree_img($level4[8]->package_amount,0).'" alt="'.$level4[8]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                                            Username : '. $level4[8]->name.' <br>
                                                                                                            Sponsor ID : '. $level4[8]->sponser_id.' <br>

                                                                                                            Package : '.$level4[8]->package_amount.' <br>
                                                                                                            Left team : '.$level4[8]->left_count.' | Right team : '.$level4[8]->right_count.' <br>
                                                                                                             Left Green Team : '.downlineTeam($level4[8]->user_id,1,'L').' | Right Green Team : '.downlineTeam($level4[8]->user_id,1,'R').'<br>
                                                                                                            
                                                                                                            Left Business : '.$level4[8]->leftPower.' | Right Business : '.$level4[8]->rightPower.' <br>
                                                                                                        </span>
                                                                                                    </a>
                                                                                                    <br>
