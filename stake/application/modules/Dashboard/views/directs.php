...
<div class="panel-heading">
        <span>AFFILIATES / MY REFERRAL</span>
    </div>
<div class="card">
    <div class="card-body">
    <!-- BEGIN page-header -->
    ...
    <div class="row">
      ...
      <div class="box-body">
          ...
          foreach ($users as $key => $user) {
            ...
            <div id="ReffList" style="display:none;">
                <div class="search-sec-1">
                    <div class="user-img">
                        <span class="number"><?php echo ($key + 1) ?></span>
                        <img src="<?php echo base_url('NewTheme/')?>assets/img/UserProfile_Pic.jpg">
                    </div>
                    <div class="search-sec-2">
                        <div class="row">

                            <div class="col-md-9 col-sm-8 col-lg-8">
                                <div class="sec-center">
                                    <div class="name"><?php echo $user['name']?>
                                        <br>
                                        <span>
                                            <i class="ti-email text-warning f-s-13 m-r-5"></i><?php echo $user['email']; ?>
                                        </span>
                                        <span>
                                            <span style="color:#FF9500;"> ID. </span><?php echo $user['user_id']; ?>
                                        </span>
                                    </div>
                                    <div class="country">
                            ...
                            <div class="col-md-3">
                                <div class="sec-right">
                                    <div class=" position">
                                        <span><?php echo $user['package_amount'];?>
                                            <!-- <span style="vertical-align: super;font-size: 12px;color: red;">$</span> -->
                                        </span>
                                        <br>
                                        <label>Package Amt.</label>
                                    </div>
                                    <div class=" starus">
                                        <?php echo $user['paid_status'] == 0 ? '<span class="btn-danger">Free</span>' : '<span class="btn-success">Paid</span>'; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
