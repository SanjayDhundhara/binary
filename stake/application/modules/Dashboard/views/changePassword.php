                      ...
                      <!-- BEGIN tab-pane -->
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                      <p class="desc"></p>
                                      <?php echo form_open('Dashboard/transaction-password',array(''));?>
                                      <div class="form-group">
                                          <label for="txtoldpass">Current Password</label>
                                          <input type="text" class="form-control" name="cpassword" value="<?php echo $user['master_key'];?>" maxlength="20" placeholder="Enter Your Old Txn Password" required="" readonly>
