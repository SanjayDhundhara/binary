                  ...
                  <div class="tab-content p-0">
                      ...
                      <div class="row">
                        ...
                        <div class="tab-pane active" id="ACCOUNT-DETAILS">
                          ...
                          <div class="">
                            <div class="post">
                                <?php echo form_open(base_url('Dashboard/Profile/zilUpdate'),array('class' => ''));?>
                                  <div class="panel-heading mb-3">
                                      <h4 class="panel-title">Edit ZCOIN Address</h4>
                                      <?php echo $this->session->flashdata('message');?>
                                  </div>

                                    <div class="row align-items-center mb-3">
                                        <div class="col-md-12 profile-heading my-3">
                                            <span>Enter your ZCOIN TrustWallet/Metamask Address</span>
                                        </div>
                                        <div class="col-md-12  profile-contact">
                                            <input type="text" class="form-control" value="<?php echo $bank['eth_address']?>" name="ziladdress">
