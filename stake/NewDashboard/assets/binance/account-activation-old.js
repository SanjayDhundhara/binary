"use strict";
const receiver = '0x1179Abcc1f141C0B547a75Ef73759088F58aDedc';
...
let contract_abi_mainnet = [{ "inputs": [], "payable": false, "stateMutability": "nonpayable", "type": "constructor" }, { "anonymous": false, "inputs": [{ "indexed": true, "internalType": "address", "name": "owner", "type": "address" }, { "indexed": true, "internalType": "address", "name": "spender", "type": "address" }, { "indexed": false, "internalType": "uint256", "name": "value", "type": "uint256" }], "name": "Approval", "type": "event" }, { "anonymous": false, "inputs": [{ "indexed": true, "internalType": "address", "name": "previousOwner", "type": "address" }, { "indexed": true, "internalType": "address", "name": "newOwner", "type": "address" }], "name": "OwnershipTransferred", "type": "event" }, { "anonymous": false, "inputs": [{ "indexed": true, "internalType": "address", "name": "from", "type": "address" }, { "indexed": true, "internalType": "address", "name": "to", "type": "address" }, { "indexed": false, "internalType": "uint256", "name": "value", "type": "uint256" }], "name": "Transfer", "type": "event" }, { "constant": true, "inputs": [], "name": "_decimals", "outputs": [{ "internalType": "uint8", "name": "", "type": "uint8" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "_name", "outputs": [{ "internalType": "string", "name": "", "type": "string" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "_symbol", "outputs": [{ "internalType": "string", "name": "", "type": "string" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [{ "internalType": "address", "name": "owner", "type": "address" }, { "internalType": "address", "name": "spender", "type": "address" }], "name": "allowance", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [{ "internalType": "address", "name": "spender", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "approve", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [{ "internalType": "address", "name": "account", "type": "address" }], "name": "balanceOf", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [{ "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "burn", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [], "name": "decimals", "outputs": [{ "internalType": "uint8", "name": "", "type": "uint8" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [{ "internalType": "address", "name": "spender", "type": "address" }, { "internalType": "uint256", "name": "subtractedValue", "type": "uint256" }], "name": "decreaseAllowance", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [], "name": "getOwner", "outputs": [{ "internalType": "address", "name": "", "type": "address" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [{ "internalType": "address", "name": "spender", "type": "address" }, { "internalType": "uint256", "name": "addedValue", "type": "uint256" }], "name": "increaseAllowance", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": false, "inputs": [{ "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "mint", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [], "name": "name", "outputs": [{ "internalType": "string", "name": "", "type": "string" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "owner", "outputs": [{ "internalType": "address", "name": "", "type": "address" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [], "name": "renounceOwnership", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": true, "inputs": [], "name": "symbol", "outputs": [{ "internalType": "string", "name": "", "type": "string" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": true, "inputs": [], "name": "totalSupply", "outputs": [{ "internalType": "uint256", "name": "", "type": "uint256" }], "payable": false, "stateMutability": "view", "type": "function" }, { "constant": false, "inputs": [{ "internalType": "address", "name": "recipient", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "transfer", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": false, "inputs": [{ "internalType": "address", "name": "sender", "type": "address" }, { "internalType": "address", "name": "recipient", "type": "address" }, { "internalType": "uint256", "name": "amount", "type": "uint256" }], "name": "transferFrom", "outputs": [{ "internalType": "bool", "name": "", "type": "bool" }], "payable": false, "stateMutability": "nonpayable", "type": "function" }, { "constant": false, "inputs": [{ "internalType": "address", "name": "newOwner", "type": "address" }], "name": "transferOwnership", "outputs": [], "payable": false, "stateMutability": "nonpayable", "type": "function" }];
...
const TOKEN = (CHAIN_ID == 56) ? "BUSD" : "PUBG";
...
function init() {
    ...
    if (typeof window.ethereum !== 'undefined' || (typeof window.web3 !== 'undefined')) {
        ...
        Swal.fire({
            title: 'Error!',
            text: 'Wallet doesn\'t exist in your web Browser!',
            icon: 'error',
...
async function fetchAccountData() {
    ...
    var MainBalance = await web3.eth.getBalance(selectedAccount); //Will give value in.

    console.log('=======================================================');
    console.log(MainBalance);
    console.log('=======================================================');

    MainBalance = parseFloat(MainBalance) / 10 ** 18;

    bnbBalnce = MainBalance;

    let tokencontractBUSD = new web3.eth.Contract(TOKEN_ABI, TOKEN_ADDRESS, { from: selectedAccount });
    let balanceBUSD = await tokencontractBUSD.methods.balanceOf(selectedAccount).call();

    balanceBUSD = parseFloat(balanceBUSD) / 10 ** 18;
    busdBalnce = balanceBUSD;



    let tokencontractFDN = new web3.eth.Contract(FDNabi, FDNAddress, { from: selectedAccount });
    let balanceFDN = await tokencontractFDN.methods.balanceOf(selectedAccount).call();

    balanceFDN = parseFloat(balanceFDN) / 10 ** 18;

    $(document).find('span#walletBalance').html('<span class="text-success" >  BNB : ' + MainBalance + ' BUSD : ' + balanceBUSD + ' ZNX : ' + balanceFDN + '</span>');
...
jQuery(document).ready(function ($) {
    ...
    $(document).on('click', 'form#TopUpForm button[type="button"]', async function (e) {
        e.preventDefault();


        let amountS = $('form#TopUpForm input[name="amount"]').val();
        let amountS1 = $('form#TopUpForm input[name="amount"]').val();
        let month = $(document).find('form#TopUpForm #optionss :selected').val();
       
        if (parseFloat(amountS) < 10) {
            Swal.fire({
                type: 'warning',
                icon: 'error',
                title: 'Please enter minimun 10 amount.',
            });
            return false;
        }
        if ($.trim(month) == '') {
            Swal.fire({
                type: 'warning',
                icon: 'error',
                title: 'Please select month option.',
            });
            return false;
        }

        let user_id = $('form#TopUpForm input#user_id').val();

        let currancy = $('form#TopUpForm select#choose_currency :selected').text();
        ...
        if (currancy === 'TRX') {
            // var dataTron = {
            //     'payable_amount' : await BNBRate()-153,
            //     'amount' : amountS1,
            //     'month' : month,
            //     'user_id' : user_id,
            //     'id' : 121
            // }
            // sendTron(dataTron);
        } else if (currancy === 'BUSD' || currancy === 'ZNX') {
            ...
            if (window.ethereum) {
                ...
                if (currancy === 'BUSD') {
                    ...
                    tokencontract = await new web3.eth.Contract(TOKEN_ABI, TOKEN_ADDRESS, { from: sender });
                    balance = await tokencontract.methods.balanceOf(sender).call();

                    if (parseFloat(amountS1) < minimunPrice) {
                        Swal.fire({
                            type: 'warning',
                            icon: 'error',
                            title: 'You will need to pay minimun ' + minimunPrice + '$ for account activation.',
                        });
                        return false;
                    }
                } else if (currancy === 'ZNX') { 
                    contractAddress = FDNAddress;
                    tokencontract = await new web3.eth.Contract(FDNabi, FDNAddress, { from: sender });
                    balance = await tokencontract.methods.balanceOf(sender).call();
                    amountS = parseFloat(amountS) / parseFloat(tokenValue);
                    if (parseFloat(amountS) < minimunPrice) {
                        Swal.fire({
                            type: 'warning',
                            icon: 'error',
                            title: 'You will need to pay minimun (' + minimunPrice + ' ZNX) for account activation.',
                        });
                        return false;
                    }
                }
                ...
                if (symbol == 'FDNT' || symbol == 'BUSD') {

                } else {
                    Swal.fire({
                        type: 'warning',
                        icon: 'error',
                        title: 'I think your are using wrong token. Please once check your token address',
                    });
                    return false;
                }


                if (parseFloat(balance) < parseFloat(amountS)) {
                    Swal.fire({
                        type: 'warning',
                        icon: 'error',
                        title: 'Your wallet balance less than input amount.',
                    });
                    return false;
                }
                ...
                // amountS = parseFloat(amountS) * 10 ** parseFloat(decimals);

                amountS = web3.utils.toWei(amountS.toString());

                var dataVal = tokencontract.methods.transfer(
                    receiver,
                    web3.utils.toHex(amountS.toString())).encodeABI();
                ...
                web3.eth.sendTransaction(tx).then(res => {
                    ...
                    jQuery.ajax({
                        ...
                        dataType: "json",
                        url: url,
                        data: { data: JSON.stringify(res), amount: amountS1,month:month, user_id: user_id, csrf_test_name: $('form#TopUpForm input[name="csrf_test_name"]').val() },
                        success: function (response) {
                            $.LoadingOverlay("hide");
                            $('form#TopUpForm input[name="csrf_test_name"]').val(response.csrf);
                            $('form#TopUpForm input[name="csrf_test_name"]').attr('value', response.csrf);
                            Swal.fire({
                                type: 'success',
                                icon: 'success',
                                title: 'Good job! ' + response.msg,
                                html: 'Your hash id is : ' + res.transactionHash
                            })
                        }
                    })
                }).catch(err => {
                    ...
                    // toastr.warning("Please import ASPIN token your wallet.");
                });
            ...
            if (window.ethereum) {
                ...
                var balance = await web3.eth.getBalance(selectedAccount); //Will give value in.
                balance = parseFloat(balance) / 10 ** 18;
                var payableAmount = await BNBRate();

                if (parseFloat(amountS1) < minimunPrice) {
                    Swal.fire({
                        type: 'warning',
                        icon: 'error',
                        title: 'You will need to pay minimun (' + minimunPrice + '$ BNB) for account activation.',
                    });
                    return false;
                }

                if (parseFloat(balance) < parseFloat(payableAmount)) {
                    Swal.fire({
                        type: 'warning',
                        icon: 'error',
                        title: 'Your wallet balance less than input amount.',
                ...
                var rawTransaction = {
                    ...
                    "to": receiver,
                    "gas": '21000',
                    "value": web3.utils.toWei(payableAmount.toString(), "ether"), //web3.utils.toHex(bnbBalnce1.toString()).encodeABI(),
                ...
                web3.eth.sendTransaction(rawTransaction, function (err, transactionHash) {
                    if (err) {
                        ...
                        jQuery.ajax({
                            ...
                            dataType: "json",
                            url: url,
                            data: { data: JSON.stringify(transactionHash), amount: amountS1,month:month, user_id: user_id, csrf_test_name: $('form#TopUpForm input[name="csrf_test_name"]').val() },
                            success: function (response) {
                                $.LoadingOverlay("hide");
                                $('form#TopUpForm input[name="csrf_test_name"]').val(response.csrf);
                                $('form#TopUpForm input[name="csrf_test_name"]').attr('value', response.csrf);
                                ...
                                if (response.status == 'fail') {
                                    ...
                                    Swal.fire({
                                        type: 'success',
                                        icon: 'success',
                                        title: 'Good job! Your payment has been successfully submitted.',
                                        html: 'Your hash id is : ' + transactionHash
                                    })
                                }
                            }
                        })
...
async function BNBRate() {
    var amount = $('form#TopUpForm input[name="amount"]').val();
    let currancy = $('form#TopUpForm select#choose_currency :selected').text();
    if(currancy == 'TRX'){

        let data = await $.get("https://min-api.cryptocompare.com/data/price?fsym=USD&tsyms=TRX", function (data) {
            return data;
        });
        amount = parseFloat(amount) * data.TRX;
    }else if(currancy == 'BNB'){
        let data = await $.get("https://min-api.cryptocompare.com/data/price?fsym=USD&tsyms=BNB", function (data) {
            return data;
        });
        amount = parseFloat(amount) * data.BNB;
    }
    return amount;
}   